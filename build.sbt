...
//      "com.amazonaws" % "aws-java-sdk-inspector" % awsSdkVersion,
      "software.amazon.awssdk" % "s3" % awsSdkVersionTwo,
      "software.amazon.awssdk" % "iam" % awsSdkVersionTwo,
      "software.amazon.awssdk" % "sts" % awsSdkVersionTwo,
      "software.amazon.awssdk" % "support" % awsSdkVersionTwo,
      "software.amazon.awssdk" % "ec2" % awsSdkVersionTwo,
      "software.amazon.awssdk" % "cloudformation" % awsSdkVersionTwo,
      "software.amazon.awssdk" % "inspector" % awsSdkVersionTwo,
...
//      "com.amazonaws" % "aws-java-sdk-sts" % awsSdkVersion,
//      "com.amazonaws" % "aws-java-sdk-s3" % awsSdkVersion,
      "software.amazon.awssdk" % "lambda-java-events" % awsSdkVersionTwo,
      "software.amazon.awssdk" % "lambda-java-core" % awsSdkVersionTwo,
      "software.amazon.awssdk" % "lambda" % awsSdkVersionTwo,
      "software.amazon.awssdk" % "config" % awsSdkVersionTwo,
      "software.amazon.awssdk" % "elasticloadbalancing" % awsSdkVersionTwo,
      "software.amazon.awssdk" % "sns" % awsSdkVersionTwo,
      "software.amazon.awssdk" % "sts" % awsSdkVersionTwo,
      "software.amazon.awssdk" % "s3" % awsSdkVersionTwo,
